...
html_content += f"""
    ...
    <div class="chart-container">
      <h2 class="chart-title">HUNTER×HUNTER 掲載・休載履歴グラフ</h2>
      ...
      <canvas id="publishChart" height="120"></canvas>
    </div>
  </div>
  ...
  <script>
    ...
    // Create datasets
    // For stepped line chart to look good with 0 and 1
    ...
    gradient.addColorStop(0, 'rgba(185, 229, 45, 0.4)');
          ...
          tooltip: {{
            ...
            callbacks: {{
              title: function(context) {{
                ...
                return d.issue + ' (発売: ' + d.x + ')';
              }},
              label: function(context) {{
                return context.raw.y === 1 ? '掲載' : '休載';
              }}
            }}
          }}
        }},
          ...
          y: {{
            ...
            ticks: {{
              ...
              callback: function(value) {{
                if (value === 1) return '掲載 (1)';
                if (value === 0) return '休載 (0)';
                return '';
              }},
              font: {{ size: 11 }}
            }}
...
print(f"HTML with chart created at {html_output_path}")
